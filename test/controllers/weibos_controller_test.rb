...
class WeibosControllerTest < ActionController::TestCase
  ...
  test "should create weibo" do
    assert_difference('Weibo.count') do
      post :create, weibo: { body: @weibo.body, btype: @weibo.btype, pid: @weibo.pid, userid: @weibo.userid, weiboid: @weibo.weiboid }
    end
  ...
  test "should update weibo" do
    patch :update, id: @weibo, weibo: { body: @weibo.body, btype: @weibo.btype, pid: @weibo.pid, userid: @weibo.userid, weiboid: @weibo.weiboid }
    assert_redirected_to weibo_path(assigns(:weibo))
  end
